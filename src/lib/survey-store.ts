...
export const DEFAULT_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      "Estudante",
      "Empregado(a) no setor privado",
      "Servidor(a) público(a)",
      "Autônomo(a) ou profissional liberal",
      "Empreendedor(a) ou empresário(a)",
      "Procurando trabalho",
      "Aposentado(a)",
      "Cuidador(a), responsável pelo lar ou sem atividade remunerada no momento",
      "Outra situação",
      "Prefiro não responder",
  ...
  },
  {
    ...
    options: [
      ...
      "Situação financeira",
      "Estudos e desenvolvimento de competências",
      "Empreendedorismo ou projetos pessoais",
      "Relacionamentos e vida social",
      "Espiritualidade e propósito",
      "Viagens e novas experiências",
      "Participação em causas ou voluntariado",
      "Organização geral da vida",
      "Ainda estou tentando descobrir meu caminho",
      "Outra área",
  ...
  },
  {
    ...
    options: [
      ...
      "Identificar meu próximo passo",
      "Começar algo que venho adiando",
      "Encontrar uma oportunidade adequada",
      "Desenvolver uma habilidade ou capacidade",
      "Resolver um problema específico",
      "Tomar uma decisão importante",
      "Criar ou manter um hábito",
      "Encontrar pessoas ou organizações que possam contribuir",
      "Acompanhar melhor meu progresso",
      "Ainda não sei exatamente o que desejo alcançar",
      "Outro resultado",
  ...
  },
  {
    ...
    options: [
      ...
      "Dificuldade para encontrar oportunidades adequadas",
      "Falta de pessoas, contatos ou apoio",
      "Dificuldade para manter disciplina ou constância",
      "Medo, insegurança ou baixa confiança",
      "Limitações de saúde ou mobilidade",
      "Responsabilidades familiares",
      "Excesso de opções e dificuldade para escolher",
      "Não encontro grandes dificuldades hoje",
      "Outro motivo",
  ...
  },
  {
    ...
    options: [
      "Pesquiso no Google",
      "Procuro em redes sociais",
      "Assisto a vídeos, leio conteúdos ou acompanho especialistas",
      "Pergunto a amigos, familiares ou conhecidos",
      "Converso com profissionais, mentores ou especialistas",
      "Utilizo sites ou aplicativos especializados",
      "Participo de eventos, grupos ou comunidades",
      "Procuro cursos, instituições ou organizações",
      "Tento descobrir sozinho, sem um caminho estruturado",
      "Não procuro ativamente no momento",
      "Outro meio",
  ...
  },
  {
    ...
    type: "single",
    title:
      "Nos últimos 12 meses, com que frequência você descobriu tarde demais uma oportunidade que poderia ter sido útil?",
    helper:
      "Uma vaga, curso, evento, projeto, benefício, grupo ou experiência que você conheceu depois do prazo.",
    options: [
      "Nunca",
      "Raramente",
      "Algumas vezes",
  ...
  },
  {
    ...
    type: "single",
    title:
      "Nos últimos 12 meses, procurou possibilidades mas não encontrou nada que fizesse sentido para o seu momento?",
    helper:
      "Considere oportunidades incompatíveis com objetivos, disponibilidade, localização, condições financeiras ou necessidades atuais.",
    options: [
      "Nunca",
      "Raramente",
      "Algumas vezes",
      "Frequentemente",
      "Muito frequentemente",
      "Não procurei oportunidades nesse período",
      "Não me recordo",
    ].map((l, i) => ({ code: `9.${i + 1}`, label: l })),
  },
  {
    id: 10,
    code: "10",
    ...
    max: 10,
    title:
      "Quanto esforço você precisa fazer hoje para encontrar algo realmente relevante para seus objetivos?",
  ...
  },
  {
    ...
    code: "13",
    section: S.D.key,
    sectionLabel: S.D.label,
    type: "scale",
    min: 0,
    max: 10,
    title:
      "Pensando na área que você escolheu antes, quanto a proposta da Guivos parece relevante para você?",
  ...
  },
  {
    ...
    options: [
      "Sei o que desejo alcançar, mas não sei qual deve ser meu próximo passo",
      "Sei o que preciso fazer, mas não encontro uma oportunidade adequada",
      "Estou vivendo uma mudança e preciso reorganizar meus caminhos",
      "Quero descobrir possibilidades que ainda não conheço",
      "Tenho muitas opções e preciso identificar o que faz mais sentido",
      "Quero organizar objetivos e acompanhar meu progresso",
      "Quero encontrar pessoas, grupos ou organizações que possam contribuir",
      "Procuraria apenas diante de uma necessidade específica",
      "Não consigo imaginar uma situação em que procuraria a Guivos",
      "Outra situação",
  ...
  },
  {
    ...
    helper: "Escolha até três opções.",
    options: [
      "Compreender melhor meu momento atual",
      "Organizar meus objetivos e prioridades",
      "Identificar próximos passos mais claros",
      "Encontrar oportunidades relacionadas aos meus objetivos",
      "Encontrar cursos, vagas, projetos, eventos ou experiências",
      "Encontrar pessoas, grupos ou organizações relevantes",
      "Receber orientações relacionadas ao meu momento",
      "Acompanhar mudanças e avanços ao longo do tempo",
      "Acessar conteúdos e conhecimentos úteis",
      "Encontrar benefícios, produtos ou serviços adequados à minha realidade",
      "Nenhuma dessas possibilidades teria valor relevante para mim",
      "Outra possibilidade",
  ...
  },
  {
    ...
    options: [
      "Descobrir uma oportunidade que dificilmente encontraria sozinho",
      "Saber com mais clareza qual deve ser meu próximo passo",
      "Economizar tempo procurando informações e possibilidades",
      "Tomar uma decisão melhor",
      "Começar a agir em direção a um objetivo",
      "Desenvolver uma habilidade ou capacidade",
      "Encontrar pessoas ou organizações que possam contribuir",
      "Manter mais constância em um objetivo",
      "Perceber e acompanhar meu progresso",
      "Nenhum desses resultados seria suficientemente relevante",
      "Outro resultado",
  ...
  },
  {
    ...
    max: 10,
    title:
      "Quanto você acredita que a Guivos poderia contribuir para você avançar nos próximos 12 meses?",
  ...
  },
  {
    ...
    code: "18",
    section: S.E.key,
    sectionLabel: S.E.label,
    type: "single",
    title: "Qual seria sua intenção de experimentar uma primeira versão da Guivos?",
    options: [
      "Certamente não experimentaria",
      "Provavelmente não experimentaria",
      "Talvez experimentasse",
      "Provavelmente experimentaria",
  ...
  },
  {
    ...
    options: [
      ...
      "Talvez, gostaria de conhecer melhor antes",
      "Não tenho interesse neste momento",
  ...
  },
  {
    ...
    code: "20",
    section: S.F.key,
    sectionLabel: S.F.label,
    type: "single",
    title: "Qual seria hoje a principal razão para você não experimentar a Guivos?",
    options: [
      "Não percebo uma necessidade real",
      "A proposta ainda parece genérica ou difícil de entender",
      "Não acredito que as oportunidades seriam realmente adequadas para mim",
      "Não acredito que a Guivos conseguiria compreender bem meu momento",
      "Teria preocupação com o uso das minhas informações",
      "Já utilizo outras soluções que considero suficientes",
      "Não teria tempo ou interesse para utilizar",
      "Não gostaria de acompanhar objetivos ou informações pessoais em uma plataforma",
      "O preço poderia se tornar uma barreira",
      "Eu experimentaria; não identifico hoje uma barreira principal",
      "Outro motivo",
  ...
  },
  {
    ...
    type: "single",
    title:
      "Se a Guivos entregasse resultados reais, você consideraria pagar por recursos adicionais?",
    options: [
      "Não consideraria pagar",
      "Talvez, dependendo dos resultados entregues",
      "Sim, até R$ 19,90 por mês",
      "Sim, entre R$ 20,00 e R$ 39,90 por mês",
      "Sim, entre R$ 40,00 e R$ 69,90 por mês",
      "Sim, acima de R$ 70,00 por mês",
...
export function newQuestion(type: QType): Question {
  ...
  if (type === "single")
    return {
      ...base,
      type,
      options: [1, 2, 3].map((n) => ({ code: `${id}.${n}`, label: `Opção ${n}` })),
    };
  if (type === "multi")
    return {
      ...base,
